...
suite('Unit Tests', function(){
  ...
  suite('Equality', function() {
    ...
    test('#equal, #notEqual', function(){
      ...
      assert.equal( 6 * '2', '12', 'string times number equals');
      assert.notEqual( 6 + '2', '12', 'rules like these makes you want to TypeScript' );
    });
...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#approximately', function() {
      assert.approximately(weirdNumbers(0.5), 1, 1, 0 );
      assert.approximately(weirdNumbers(0.2), 1, 1, 0 );
    });
  });
